	...
	<form id="itemAddForm" class="itemForm" method="post">
	    <table cellpadding="5">
	        ...
	        <tr>
	            <td>商品图片:</td>
	            <td>
	            	<!-- easyui-linkbutton picFileUpload弹框类型 -->
...
<script type="text/javascript">
	...
	$(function(){
		...
		KindEditorUtil.init({fun:function(node){
			//根据商品分类的id查询具体商品id,在根据商品id取出商品的规格模板,生成商品规格信息
	...
	function submitForm(){
		...
		//取除商品规格参数
		//提交表单之前，先把规格参数表单中的内容转换成json数据然后跟商品基本信息
		//商品描述同时提交给后台。保存至数据库。
		var paramJson = [];
		...
		$.post("/item/save",$("#itemAddForm").serialize(), function(data){
			if(data.status == 200){
				$.messager.alert('提示','新增商品成功!','info',function(){
					...
					location.href="http://manage.jt.com/index";
				});
			}else{
