<%@ page language="java" contentType="text/html; charset=UTF-8"
	pageEncoding="UTF-8"%>
<!-- 表格easyui-datagrid  singleSelect:false多选   url:/item/query    pagination:true分页pageSize:20每页的页数初始是20  toolbar:toolbar工具栏(新增) -->
<table class="easyui-datagrid" id="itemList" title="商品列表"
	...
	<thead>
		<tr>
			...
			<!-- formatter:KindEditorUtil.formatPrice 格式化价格 在common.js -->
