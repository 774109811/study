...
<div class="w">
    <div id="logo">
    	<a href="http://www.jt.com/" clstag="passport|keycount|login|01">
    		<img src="/images/jt-logo.png" alt="浜�娣�" width="170" height="60"/>
    	</a><b></b>
   	</div>
</div>
    ...
    <div class=" w1" id="entry">
        <div class="mc " id="bgDiv">
            ...
            <div class="form ">
                ...
                <div id="capslock"><i></i><s></s>����澶у����瀹�宸叉��寮�锛�璇锋敞��澶у���</div>
                    ...
                    <div class="item-ifo">
                        ...
                        <script type="text/javascript">
							$('#nloginpwd')[0].onkeypress = function(event){
								...
								$tip = $('#capslock'),
								kc  =  e.keyCode||e.which, // ������keyCode
								isShift  =  e.shiftKey ||(kc  ==   16 ) || false ; // shift��������浣�
                ...
                <div class="item fore3  hide " id="o-authcode">
                    ...
                    <div class="item-ifo">
                        ...
                        <label class="ftx23 hline">��涓�娓�锛�<br><a href="javascript:void(0)" class="flk13"
                                                              onclick="jQuery('#JD_Verification1').click();">��涓�寮�</a></label>
                ...
                <div class="item fore4 hide" id="autoentry">
                    <div class="item-ifo">
                        ...
                        <label class="mar">���ㄧ�诲�</label>
                            ...
                            <label class="mar" id="jdsafe">瀹��ㄦ�т欢�诲�<div class="tip-safe" style="display:none;" id="tip-safe">瀹��ㄦ�т欢����楂�璐��峰���ㄦ�э���瀵�淇��ゆ�ㄧ��瀵�����</div></label>
                        </div>
                                                <label><a href="http://safe.jd.com/findPwd/index.action" class="" clstag="passport|keycount|login|05">蹇�璁板����?</a></label>
                        <div class="clr"></div>
                    </div>
                    <div class="updata" id="updata" style="display:none;">瀹��ㄦ�т欢��绾т�!<a href="javascript:void(0);" onclick="updateCtl()" class="up-two"></a>绔��虫�存��</a> <a class="up-one" href="javascript:void(0);" onclick="$('#updata').hide();"></a></div>
                </div>
                <div
              <img src="checkCode" alt="" width="100" height="32" class="passcode" style="height:43px;cursor:pointer;" onclick="this.src=this.src+'?'"/> 
                </div>
                <div class="item login-btn2013">
                    <input type="button" class="btn-img btn-entry" id="loginsubmit" value="�诲�" tabindex="8" clstag="passport|keycount|login|06"/>
                </div>
            </div>
                <div class="coagent hide" clstag="passport|keycount|login|07">
                    <label class="ftx24">
                        浣跨�ㄥ��浣�缃�绔�璐��风�诲�浜�娣�锛�
                        ...
                        <dl class="btns more-slide">
                            ...
                            <dd>
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/netease/login.action'+window.location.search;return false;">缃���</a>			   
								<a style="margin-left:30px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/renren/login.action'+window.location.search;return false;">浜轰汉</a>
								<br>
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/douban/login.action'+window.location.search;return false;">璞���</a>
								<a style="margin-left:30px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/sohu/login.action'+window.location.search;return false;">����</a>
                                <br>
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/kaixin001/login.action'+window.location.search;return false;">寮�蹇�</a>
								<a style="margin-left:30px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/alipay/login.aspx'+window.location.search;return false;">��浠�瀹�</a>
								<br>								
								<a href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/qihao/login.action'+window.location.search;return false;">濂���360</a>
								<a style="margin-left:10px;" href="javascript:void(0)"
                                               onclick="window.location='http://qq.jd.com/new/sina/login.action'+window.location.search;return false;">�版氮寰���</a>
                            </dd>
                        </dl>
        ...
        <div class="free-regist">
            <span><a href="http://www.jt.com/user/register.html" clstag="passport|keycount|login|08">注册&gt;&gt;</a></span>
        </div>
    </div>
</form>
<div class="w1">
